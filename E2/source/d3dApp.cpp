...
bool D3DApp::InitDirect3D() {
    ...
    {
        D3D_DRIVER_TYPE_HARDWARE,  //3D硬件加速
        D3D_DRIVER_TYPE_WARP,	   //Direct3D 10.1软件驱动器
        D3D_DRIVER_TYPE_REFERENCE, //Direct3D的软件实现
    };
    ...
    if (featureLevel != D3D_FEATURE_LEVEL_11_0) {
        MessageBox(0, L"Direct3D Feature Level 11.0 unsupported.", 0, 0);
        return false;
    }
